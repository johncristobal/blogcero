                                                    ...
                                                    foreach ($enfermedades as $value) {
                                                        ...
                                                        <?php
                                                            ...
                                                            if((isset($variable[$newstring])) && ($variable[$newstring] != "")){ ?>    
                                                                <label class="alineacion align-left"><?= $enfermedadesshow[$x]; ?></label><input type="checkbox" name="<?= $newstring; ?>" checked="true" disabled="true">
                                                        <?php }else{ ?>
						...
						<tr>
							<td class="Separador" colspan="5"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan ="2"><textarea class="tam" id="observaprofesor" name="observaprofesor" rows="6" cols="3" style="background: rgba(100, 100, 100, 0.8)" @if(Session::has('isAdmin')) disabled="true" @endif>{{ $observacionesprofe }}</textarea></td>
                                                </tr>
                                                <tr>
                                                        <td class="Separador" colspan="6"></td>
                                                </tr>						<tr>
							<td colspan="5" @if(Session::has('isAdmin')) style="display:none;" @endif>
