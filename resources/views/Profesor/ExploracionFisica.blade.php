				...
				<tr>
					<td class="Separador" colspan="2"></td>
                            ...
                            <tr>
                                ...
                                <td><textarea class="tam" name="observaprofesor" id="observaprofesor" rows="6" cols="3" style="background: rgba(100, 100, 100, 0.8)" @if(Session::has('isAdmin')) disabled="true" @endif>{{$observaprofe}}</textarea>
                            </tr>
