	...
	<head>
		...
		<fieldset>
			<h3>ÍNDICE CPOD</h3>
                        ...
                        <fieldset>
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2"><textarea class="tam" id="observaprofesor" name="observaprofesor" rows="6" cols="3" style="background: rgba(100, 100, 100, 0.8)" @if(Session::has('isAdmin')) disabled="true" @endif>{{$observaprofe}}</textarea>
                                </tr>
                                <tr>
					<td colspan="2"></br></td>
				</tr>
				...
				<tr>
                                    <td colspan="2"></td>
					<td @if(Session::has('isAdmin')) style="display:none;" @endif>
