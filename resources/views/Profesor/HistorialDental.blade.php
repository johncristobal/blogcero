		...
		<div id="page-wrapper">
			...
			<!-- Banner -->
				...
				<img src="{{url::asset('/')}}imagenes/Odontograma.jpg" USEMAP="#Odontograma">
					...
					<area href="{{URL::asset('/')}}Profesor/Expediente/HigOral/HistorialDental/32-I" shape="circle" coords="360,250,10" alt="32-V">
					...
					<area href="{{URL::asset('/')}}Profesor/Expediente/HigOral/HistorialDental/33-I" shape="circle" coords="395,250,10" alt="33-V">
				...
				<br>
				@if(count($errors))
                        <h5 style="color: #ff0066;">Favor de llenar los campos marcados con *</h5>
                    @endif
				<br>
				<h4>Ingresar nuevo diagnóstico y tratamiento</h4>
