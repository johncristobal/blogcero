                                    ...
                                    <table width='100%'>
                                        <tr>
                                            <td>Observaciones <br/>profesor:</td>
                                                <td colspan ="2"><textarea class="tam" name="observaprofesor" id="observaprofesor" rows="6" cols="3" style="background: rgba(100, 100, 100, 0.8)" @if(Session::has('isAdmin')) disabled="true" @endif>{{ $observaprofe }}</textarea></td>
                                        </tr>
                                        <tr>
                                            <td class="Separador" colspan="6"></td>
                                        </tr>
