			...
			<!-- Banner -->
				<section id="banner">
					...
					<table border ="0" align="center" class="default">
                                        ...
                                        $enfermedades = ["Tuberculosis","Poliomielitis (Sabin)","Pentavalente (DPT+HB+HIB)","Difteria, Tosferina y Tétanos","Sarampión, Rubéola y Parotiditis","Hepatitis B","Otra"];
				...
				<table border="0" align="center">
					...
					<tr>
						...
						<td class="Separador" colspan="2"></td>
                                        ...
                                        <tr>
                                            <td>Observaciones <br/>profesor:</td>
                                                <td colspan ="2"><textarea class="tam" name="observaprofesor" id="observaprofesor" rows="6" cols="3" style="background: rgba(100, 100, 100, 0.8)" @if(Session::has('isAdmin')) disabled="true" @endif>{{ $observacionesprofe }}</textarea></td>
                                        </tr>
                                        <tr>
                                            <td class="Separador" colspan="6"></td>
                                        </tr>
