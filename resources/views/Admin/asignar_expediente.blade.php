	...
	<form method="post" action="{{url::asset('/')}}Expediente/Reasignar">
		<table  border ="0" class="form">
			<tr>
                            ...
                            <td>
                                <select name="estudiante" style='width: 20em;'>
			...
			<tr>
                            ...
                            <td>
                                <select name="exped" style="width: 20em;">
                                    @foreach($expedientes as $value)
                                    <option value="{{$value->id}}">{{$value->folio_expediente}} - {{$value->nombre_paciente}} {{$value->ap_paterno}}</option>
                                    @endforeach
                                </select>
                            </td>		
			</tr>
