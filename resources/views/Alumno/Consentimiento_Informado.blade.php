				...
				<form method="POST" action="{{url::asset('/')}}pdfConsent">
			 	...
			 	<pre>
				 	A través del presente, declaro y manifiesto, en pleno uso de mis facultades mentales que he sido informado/a 
	          		...
	          		si es preciso, tratamientos remitidos con alguna interconsulta, tanto de carácter médico y quirúrgicos, incluyendo 
	          		el uso de anestesia local; siempre que el tratamiento lo amerite y bajo la atención del responsable y 
	          		mínimo un asistente.		         
		          	...
		          	evolución de mi proceso de  cada uno de los tratamientos, de manera verbal y/o escrita.		         
		          	Si surgiese cualquier situación inesperada o sobrevenida durante la intervención o tratamiento, autorizo al responsable 
		          	a realizar cualquier procedimiento o maniobra distinta de las proyectadas o usuales que a su juicio estimase oportuna para
	          	 	la resolución teniendo siempre una justificación.		       
		          	...
		          	Doy mi consentimiento y por ende al equipo de ayudantes que se designe según el tratamiento lo requiera.
		        </pre> 
						
				
				<table width="100%" class="default" border="0">
					<tr>
