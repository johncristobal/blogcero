			...
			<form method="post" action="{{url::asset('/')}}Expediente/Alta/Nota">
				...
				<tr>
					<td><label>Nombre del Paciente</label></td>
                                        <td><input type="text" class="form" name="nombre" value="{{ $nombre }}" readonly="true" size="50"></td>
				</tr>
				<tr>
				...
				<tr>	
					<td><label>Edad</label></td>
                                        <td><input type="text" class="form" name="edad" value="{{ $edad }}" readonly="true"></td>
				</tr>
				<tr>
					<td class="Separador" colspan="2"></td>
				</tr>
				<tr>
					<td><label>G&eacute;nero</label></td>
                                        <td><input type="text" class="form" name="genero" value="{{ $genero }}" readonly="true"></td>
				</tr>
				<tr>
					<td class="Separador" colspan="2"></td>
				</tr>
				<tr>
					...
					<td><input type="text" class="form" value="{{ $num }}" readonly="true"></td>
				</tr>
				<tr>
					<td class="Separador" colspan="2"></td>
				</tr>
