...
<html>
	...
	<body class="index">
			...
			<table class="table" id="buscador" width="100%">
                            ...
                            <section style="text-align: right;margin-right: 100px; margin-bottom: 50px;">
                                <a href="{{url::asset('/')}}Notas/Nueva" class="button special">Agregar nota</a>
                            </section>
