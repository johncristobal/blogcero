...
Route::get('Usuarios/recoverpass',function(){
    return view('recuperar');
});

Route::post('Usuarios/recoverpass','UsuariosController@sendmailpass');

Route::post('Usuarios/Altaprofesor','UsuariosController@storeProfesor');

Route::get('Usuarios/altaprofesor',function(){
    return view('Admin.Altaprofe');
});
...
Route::get('Notas/Nueva','NotaController@NuevaNota');
Route::post('Notas/UpdateNota','NotaController@UpdateNota');
...
//RutaS ADMIN VISTAS EXPEDIENTES
//cambio 4 cambiar rutas para que digan admins
Route::get('Admin/Expediente/principal','ExpedienteProfesorController@verExpedienteProf');
...
Route::get('Profesor/Nota/firmarNota','NotaController@firmarnota');

Route::post('Profesor/Nota/salvarobservaciones','NotaController@salvarobservaciones');
Route::post('Profesor/Nota/validarnota','NotaController@validarNotaF');
...
Route::get('Usuarios/cambiarcontrasena', 'UsuariosController@contrasena');
Route::post('Usuarios/cambiarcontrasena', 'UsuariosController@contrasenaStore');
Route::get('Usuarios/cambiarcontrasenaprofesor', 'UsuariosController@contrasenaprofe');

//RutaS ADMIN VISTAS EXPEDIENTES
//cambio 4 cambiar rutas para que digan admins
Route::get('Admin/Expediente/principal','ExpedienteProfesorController@verExpedienteProf');
Route::get('Admin/Expediente/FichaExp','ExpedienteProfesorController@FichaExp');

Route::get('Admin/Expediente/FamHeder', 'ExpedienteProfesorController@Heredofami');

Route::get('Admin/Expediente/AntescPat', 'ExpedienteProfesorController@Patologicos');

Route::get('Admin/Expediente/AntescNoPat', 'ExpedienteProfesorController@Nopatologicos');

Route::get('Admin/Expediente/Aparatos', 'ExpedienteProfesorController@Aparatos');

Route::get('Admin/Expediente/Mujeres', 'ExpedienteProfesorController@Mujeres');

Route::get('Admin/Expediente/ExplFisica', 'ExpedienteProfesorController@Fisica');

Route::get('Admin/Expediente/HigOral', 'ExpedienteProfesorController@Bucal');

Route::get('Admin/Expediente/Diagnostico', 'ExpedienteProfesorController@Resumen');

Route::get('Admin/Nota/notas', 'NotaController@Notaprofesor');
Route::get('Admin/Notas/principal','NotaController@vernotaprofesor');
