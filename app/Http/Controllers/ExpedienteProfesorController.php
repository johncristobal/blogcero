...
//******************************ver expediente    
    ...
    public function verExpedienteProf(Request $request){
        ...
        if ($request->session()->has('folioexpediente')) {
            ...
            $ficha = Direccion::where('folio_expediente','=',$idexped)->get();
            $heredo = Heredofamiliares::where('folio_expediente','=',$idexped)->get();
            $antece = Patologicos::where('folio_expediente','=',$idexped)->get();
            $napato = Nopatologicos::where('folio_expediente','=',$idexped)->get();
            $aparatos = Aparatossistemas::where('folio_expediente','=',$idexped)->get();
            $mujeres = Mujeres::where('folio_expediente','=',$idexped)->get();
            $explo = Exploracionfisica::where('folio_expediente','=',$idexped)->get();
            $higie = Bucalcpod::where('folio_expediente','=',$idexped)->get();
            $resumen = Resumen::where('folio_expediente','=',$idexped)->get();
            ...
            if($isadmin == "1"){
                return view('Admin.principal',$datos);        
                
            }else{
                return view('Profesor.principal',$datos);        
...
/************************store/load ficha patologicos********************/
    ...
    public function firmarguardar(Request $request){                
        ...
        //Recuperar firma del profesor y validar....
