...
class ExpedienteController extends Controller
{
    ...
    public function buscar()
    {
        ...
        //$datos['data'] = $clinica;
        //cambio 1. agregar datos a consulta
        $facturasCliente = DB::table('expediente')
            ...
            ->select('usuarios.name','usuarios.pat', 'expediente.nombre_paciente','expediente.fecha_inicio','expediente.folio_expediente','expediente.id','expediente.ap_paterno','expediente.status')
    ...
    {        
        ...
        \Illuminate\Support\Facades\File::makeDirectory($request->input('NoExp'));
...
/****************Expediente/Alta/Nota********************************/
    public function storeNota(Request $request){
        ...
        $nota = new Notaevolucion;
        $nota->status = 1;
        $nota->folio_expediente = $id;
        $nota->fecha = $request->input('fecha');
        $nota->referencia = $request->input('ref');
        $nota->contraref = $request->input('contra');
...
/************************store/load ficha patologicos********************/
    ...
    //Expediente/validarStatus
    public function getLast(Request $request){
        //recuperra ide expedinte
        $id = $request->session()->get('idexpediente','0');
        $tipo = $request->input('tipo');

        //Use this same method to new rule admin
